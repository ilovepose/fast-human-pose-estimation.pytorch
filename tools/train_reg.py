...
##########################################################
from core.loss import JointsMSELoss, L1JointLocationLoss
from core.function_reg import train_reg
from core.function_reg import validate_reg
##########################################################
...
######################################################################
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        # train for one epoch
        train_reg(cfg, train_loader, model, criterion, optimizer, epoch,

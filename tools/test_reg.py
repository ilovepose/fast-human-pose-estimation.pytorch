...
from core.loss import JointsMSELoss, L1JointLocationLoss, L1BiasLoss
from core.function_reg import validate, validate_reg
...
def main():
    ...
    validate_reg(cfg, valid_loader, valid_dataset, model, criterion,
